...
public class CalendarioHaab extends javax.swing.JFrame {
     ...
     */
    public CalendarioHaab(Usuario usuario) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton7.setBackground(new java.awt.Color(134, 134, 134));
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ModificarHaab mh= new ModificarHaab(this, rootPaneCheckingEnabled);
        mh.setVisible(true);
